...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <a href="{{ route('aggregator.hvcdp.count')}}" class="btn btn-primary">Add Record</a>
            <div>
                <a href="{{ route('aggregator.hvcdp.print', ['from_date' => request('from_date'), 'to_date' => request('to_date'), 'barangay' => request('barangay')]) }}" class="btn btn-primary" target="_blank">Print</a>
                <button class="btn btn-secondary">CSV</button>
                <a href="{{ route('aggregator.hvcdp.exportExcel', ['barangay' => request('barangay'), 'from_date' => request('from_date'), 'to_date' => request('to_date')]) }}" class="btn btn-success" target="_blank">Export Excel</a>
