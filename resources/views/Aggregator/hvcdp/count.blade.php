...
<div class="container">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('aggregator.hvcdp.store') }}" method="POST" id="crop-form">
            @csrf
            <div class="form-row">
                <!-- Farmer input -->
...
$(document).ready(function() {
    ...
    $('.btn-edit').click(function() {
        var id = $(this).data('id');
        $.ajax({
            url: '{{ route("aggregator.hvcdp.edit", ":id") }}'.replace(':id', id),
            method: 'GET',
    ...
    $('#edit-crop-form').submit(function(e) {
        ...
        $.ajax({
            url: '{{ route("aggregator.hvcdp.update", ":id") }}'.replace(':id', id),
            method: 'POST',
            data: formData,
            success: function(data) {
