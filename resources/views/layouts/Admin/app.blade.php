            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('hvcdp.count')}}">HVCDP - Counts</a>
                        <a class="collapse-item" href="{{ route('hvcdp.index')}}">HVCDP - Records</a>
                    </div>
                </div>
            </li>
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <!-- <h6 class="collapse-header">Lists:</h6> -->
                              <a class="collapse-item" href="{{ route('roles.createUser')}}">ADMIN - Users Lists</a>
                              <a class="collapse-item" href="{{ route('farmers.create') }}"> Farmers Lists</a>
                              <a class="collapse-item" href="{{ route('affiliations.index')}}">Lists of Affiliations</a>
